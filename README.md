...
- **ระบบสแกนเนอร์พรีเมียม (Webcam & File QR Scanner)**: ระบบใช้ไลบรารีระดับสูง `qr-scanner` (Nimiq) ที่ทำงานถอดรหัสในเบื้องหลังผ่าน Web Worker เพื่อความรวดเร็วและไม่หน่วงเทรดหลักของบราวเซอร์ นอกจากนี้ยังมีฟังก์ชัน **"Upload QR Image"** เพื่อให้ผู้ใช้สามารถอัปโหลดไฟล์รูปภาพหรือภาพหน้าจอ (Screenshot) ของ QR Code เพื่อทำการถอดรหัสและป้อนค่า SDP ได้โดยตรง เพิ่มความสะดวกสบายสูงสุดแม้ในอุปกรณ์ที่ไม่มีกล้องเว็บแคม
