        ...
        <div className="mb-4 flex flex-wrap gap-2">
          {bases.map((b) => (
            <button
              ...
              className={`rounded-lg px-3 py-1.5 text-xs font-medium transition-colors ${fromBase === b.base ? 'bg-primary text-primary-foreground' : 'bg-secondary text-muted-foreground hover:text-foreground'}`}
            >
              {b.label}
            </button>
          ))}
