...
export default function TextDiffTool() {
  ...
  // Sub-word level diff for split line comparables
              ...
              <table className="w-full border-collapse">
                <tbody>
                  {diffResult.map((part, _i) => {
                    ...
                    // Since 'diff' gives us chunks, we will iterate and build aligned rows.
                    return null
                  })}
                  ...
                  {(() => {
                    ...
                    for (let i = 0; i < diffResult.length; i++) {
                      ...
                      if (part.removed && diffResult[i + 1]?.added) {
                        // Modification block (removed then added)
